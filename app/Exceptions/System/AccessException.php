...
final class AccessException extends RuntimeException implements ApplicationExceptionInterface
{
    public function __construct(string $message = '', int $code = Response::HTTP_FORBIDDEN, Throwable $previous = null)
    {
        $message = empty($message) ? trans('exceptions.m3') : $message;
